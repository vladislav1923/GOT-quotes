...
export default function Header({ bgColor }: Props) {
  ...
  return (
    <header className={styles.container}>
      <span className={`${styles.title} ${fontColorClassName}`}>Game Of Thrones Quotes</span>
      <p className={`${styles.desc} ${fontColorClassName}`}>Fiery collection of quotes from Game of Thrones</p>
    </header>
  );
}
